...
async function checkTxProcessed(cliinput, flags) {
	console.time("txProc timestamp");
	...
	console.log('connecting to : ' + conf.rskNodeProvider)
		...
		while (true) {
			try {
				...
				if (!numberOfTransactions) {
					console.log("wait 5 numberOfTransactions: " + numberOfTransactions)
					await wasteTime(5)
					continue
				}
...
export default checkTxProcessed
